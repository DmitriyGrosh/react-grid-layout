...
export function compactItem(
  ...
  while (
    ...
    if (compactH) {
      console.log(`==========>x + w = ${collides.x + collides.w}`, collides);
      console.log('==========>1 + collides.w', 1 + collides.w);
      resolveCompactionCollision(fullLayout, l, 1 + collides.w, "x");
    } else {
      console.log(`==========>y + h = ${collides.y + collides.h}`, collides);
      console.log('==========>1 + collides.h', 1 + collides.h)
      resolveCompactionCollision(fullLayout, l, 1 + collides.h, "y");
    }
